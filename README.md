# monolog-pack
[![Packagist Version](https://img.shields.io/packagist/v/mrgoodbytes8667/monolog-pack?logo=packagist&logoColor=FFF&style=flat)](https://packagist.org/packages/mrgoodbytes8667/monolog-pack)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/mrgoodbytes8667/monolog-pack?logo=php&logoColor=FFF&style=flat)](https://packagist.org/packages/mrgoodbytes8667/monolog-pack)
...
![Packagist License](https://img.shields.io/packagist/l/mrgoodbytes8667/monolog-pack?style=flat)
![GitHub Release Workflow Status](https://img.shields.io/github/actions/workflow/status/mrgoodbytes8667/monolog-pack/release.yml?label=stable%20build&logo=github&logoColor=FFF&style=flat)  
A pack whose recipe sets up monolog with an alternate base configuration
...
```console
$ composer require mrgoodbytes8667/monolog-pack
```
